...
const ExperienceValor = () => {
  return (
    <>
      ...
      <motion.div
        className="bg-[#023047] lg:hidden overflow-hidden flex flex-col-reverse lg:flex-row items-stretch"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
      >
        ...
        >
          <motion.h2
            className="text-[24px] md:text-[40px] font-[700] text-white leading-[32px] md:leading-[50px] mb-4"
            variants={{
              hidden: { opacity: 0, y: 20 },
              visible: {
                opacity: 1,
          ...
          <motion.p
            className="text-[16px] md:text-[20px] text-[#E1E1E1] leading-[20px] md:leading-[24px] mb-8"
            variants={{
              hidden: { opacity: 0, y: 20 },
              visible: {
                opacity: 1,
          ...
          >
            ...
            <a
              href="#"
              className="bg-white rounded-[10px] p-3 flex items-center gap-3 hover:bg-gray-100 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
