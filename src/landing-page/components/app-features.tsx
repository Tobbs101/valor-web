    ...
    <div className="bg-white py-[50px] md:py-[80px] overflow-hidden">
      <Container className="mb-8 px-5">
        <motion.h1
          ...
          className="w-full text-[48px] text-primary leading-[56px] mb-5 md:text-[48px] font-[700] text-center"
        >
          App Features
        </motion.h1>
        <motion.p
          ...
          className=" text-[16px] text-center text-[#323232] leading-[20px] md:leading-[24px] md:text-[20px] font-[400] md:text-base"
        >
        ...
        <motion.div
          className="mt-16 flex flex-col lg:flex-row items-center gap-10 lg:gap-20"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          >
            ...
            <p className="text-[16px] font-[400] md:text-[18px] text-[#646464] leading-[26px]">
          ...
          <div className="flex-1 flex items-center justify-center lg:justify-start">
            <div className="relative w-full max-w-[550px] min-h-[420px] flex flex-col items-center justify-center">
              ...
              >
                <div className="w-[60px] h-[60px] rounded-full overflow-hidden relative flex-shrink-0 bg-gray-200">
                  <Image
                    src={FleetRentals}
                    alt="Fleet rentals"
                    fill
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-[18px] font-[700] text-primary truncate">
                    Fleet rentals and logi...
                  </h4>
                  <p className="text-[14px] text-[#646464]">Oct 04, 05:45 AM</p>
                </div>
                <div className="w-[45px] h-[45px] rounded-full bg-[#FFEEE8] flex items-center justify-center flex-shrink-0">
                  <Icon
                    strokeWidth={2}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-[18px] font-[700] text-primary">
                    SIG Motors
                  </h4>
                  <p className="text-[14px] text-[#646464]">Oct 22, 06:30 pM</p>
                </div>
                <div className="w-[45px] h-[45px] rounded-full bg-[#FFEEE8] flex items-center justify-center flex-shrink-0">
                  <Icon
                    strokeWidth={2}
        ...
        >
          ...
          <div className="flex-1 flex items-center justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] min-h-[450px] flex items-center justify-center">
              ...
              <motion.div
                className="relative z-10 bg-white rounded-[20px] p-5 shadow-lg border border-[#969696] ml-auto"
                variants={{
              ...
              >
                <div className="flex gap-4">
                  {/* Vehicle Card 1 */}
                  <motion.div
                    className="w-[180px] border border-[#F4F4F4] rounded-xl"
                    variants={{
                  ...
                  >
                    <div className="relative h-[130px] rounded-t-[12px] overflow-hidden">
                      <Image
                        src={Highlander}
          ...
          >
            <h2 className="text-[32px] text-left md:text-[40px] font-[700] text-primary leading-[40px] md:leading-[48px] mb-4">
              Verified Vehicles and Hosts
            </h2>
            <p className="text-[16px] font-[400] text-left md:text-[18px] text-[#646464] leading-[26px]">
        ...
        >
          ...
          >
            ...
            <p className="text-[16px] font-[400] md:text-[18px] text-[#646464] leading-[26px] mb-10">
            ...
            <div className="relative">
              ...
              <div className="absolute left-[5px] top-[12px] bottom-[12px] w-[2px] border-l-2 border-dashed border-[#7DD3FC]"></div>
              ...
              <div className="space-y-10">
                ...
                >
                  ...
                  <div>
                    <h4 className="text-[18px] font-[700] text-primary mb-2">
                      Search for car by city
                    </h4>
                    <p className="text-[14px] text-[#646464] leading-[22px]">
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-8 max-w-[500px]">
              ...
              >
                <div className="w-[60px] h-[60px] rounded-full bg-[#E0F2FE] border-2 border-[#7DD3FC] flex items-center justify-center mb-4">
                  <Icon
                    icon="mdi:hours-24"
              ...
              >
                <div className="w-[60px] h-[60px] rounded-full bg-[#FEF9C3] border-2 border-[#FDE047] flex items-center justify-center mb-4">
                  <Icon
              ...
              >
                <div className="w-[60px] h-[60px] rounded-full bg-[#FECACA] flex items-center justify-center mb-4">
                  <Icon
                    icon="mdi:airplane"
              ...
              >
                <div className="w-[60px] h-[60px] rounded-full bg-[#D1FAE5] flex items-center justify-center mb-4">
                  <Icon
          ...
          <div className="relative -mt-[480px] px-5 md:px-10">
            <div className="flex flex-col lg:flex-row gap-10 max-w-[95%] mx-auto">
              ...
              >
                ...
                <button className="bg-primary text-white px-8 py-3 rounded-full text-[15px] font-[600] w-fit mb-3 hover:bg-primary/90 transition-colors">
                  Sign Up
                </button>
        ...
        <motion.div
          className="mt-24 bg-[#D2F0FF] rounded-[24px] py-12 px-8 md:px-12 overflow-hidden"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
        >
